        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    @if(Auth::user()->gender == 'Male' && Auth::user()->profile_pic == 'Image will be here')
                    <img src="/uploads/man.png" class="user-img" alt="user avatar">
                    @elseif(Auth::user()->gender == 'Female' && Auth::user()->profile_pic == 'Image will be here')
                    <img src="/uploads/woman.png" class="user-img" alt="user avatar">
                    @elseenv
                    <img src="/uploads/{{Auth::user()->profile_pic}}" class="user-img" alt="user avatar">
                    @endif
                    <div class="user-info">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                           <div class="d-flex align-items-center">
                             <div><i class="bx bx-log-out-circle"></i></div>
