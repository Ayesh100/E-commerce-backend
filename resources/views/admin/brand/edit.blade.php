                                ...
                                <div class="col-lg-8">
                                    <div class="border border-3 p-4 rounded">
                                              ...
                                              @foreach ($categories as $category)
                                                  <div class="form-check col-md-4">
                                                      <input type="checkbox"
                                                          ...
                                                          name="category_ids[]"
                                                          value="{{ $category->id }}"
                                                          {{ $brand->categories->contains($category->id) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="brand_name" value="{{ old('brand_name', $brand->brand_name) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="brand_slug" value="{{ old('brand_slug', $brand->brand_slug) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img src="/uploads/{{ $brand->brand_logo }}" width="100" height="100"
                                                alt="">
                                        </div>
                                        <div class="mb-3">
